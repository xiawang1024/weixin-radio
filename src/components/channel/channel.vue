<template>
  <div class="channel">
    ...
    <tab-slider class="tab-slider-wrap" v-if="itemsData.length>0" ref="tabslider">
      <scroll
      ...
      >
        <div class="scroll">
          ...
          >
            <div class="icon item">
              <img
                :src="item.image.indexOf('http://')==-1 ? 'http://program.hndt.com' + item.image : item.image"
                class="img"
              >
            </div>
            <div class="live-info item">
              ...
              <p class="live-name">
                <i class="icon-LIVE" v-if="item.live"></i>
                {{item.live}}
              </p>
